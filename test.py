...
class TestMLOpsWorkflow(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if not os.path.exists(self.data_path):
            ...
            data = {
                ...
                'ocean_proximity': np.random.choice(['<1H OCEAN', 'INLAND', 'NEAR OCEAN', 'NEAR BAY'], n_samples)
            }
    ...
    def test_model_prediction(self):
        ...
        try:
            ...
            logger.info(f"Model prediction metrics - RMSE: {rmse:.2f}, MAE: {mae:.2f}")
    ...
    def test_end_to_end_workflow(self):
        ...
        try:
            ...
            logger.info(f"End-to-end workflow metrics - RMSE: {rmse:.2f}, R²: {r2:.4f}")
